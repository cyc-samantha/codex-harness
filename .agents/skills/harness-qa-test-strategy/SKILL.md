...
description: "Use when user wants to Test phase skill: spawn qa-engineer to map acceptance criteria to tests, identify coverage gaps, and write integration/E2E tests."
context: fork
agent: qa-engineer
---
...
Agent({
  ...
  prompt: "Analyze test coverage for this feature:
    ...
    6. Analyze maestro/ E2E flows:
       ...
       - Write new Maestro flows if gaps are found (follow patterns in .agents/skills/harness-react-native-patterns/SKILL.md)
