---
name: "debug"
description: "Persistent debug state management for complex, multi-session bugs. Maintains structured debug state files under HARNESS_DATA that survive context compaction."
