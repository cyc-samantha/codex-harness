---
name: "harness-config"
description: "Modify the harness itself: hooks, settings, agent definitions, skill infrastructure. Delegates non-.md changes to an infrastructure-engineer with worktree isolation."
---
