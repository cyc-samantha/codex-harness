---
name: "patch-critique"
description: "Use for Final-Gate evaluation of a candidate patch by test results + diff (not SOLID/DRY)."
context: fork
agent: patch-critic
---
...
Agent({
  ...
  prompt: "Read .agents/skills/harness-patch-critique/SKILL.md and execute fully.
