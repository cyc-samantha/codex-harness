---
name: "infra-scaffold"
description: "Use when user wants to Generate production-ready infrastructure config: Dockerfile, docker-compose, CI/CD pipeline, health endpoints, env management."
context: fork
