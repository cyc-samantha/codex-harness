...
description: "Full greenfield project bootstrap: product discovery, tech stack decision, UI architecture, framework init, DevX setup, design system, infrastructure, and seed data."
