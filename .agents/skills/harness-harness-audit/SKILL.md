---
name: "harness-audit"
description: "Use when user wants to Audit the health of the ~/.claude/ config: orphan hooks, missing skills, stale agents, JSON validity, hook executability."
...
- Check `.agents/skills/harness-{skill-name}/SKILL.md` OR `~/.claude/skills/_deferred/{skill-name}/SKILL.md` exists for each. Deferred skills remain invokable via forcing-function or channel-gated routing — only flag missing if neither path resolves.
