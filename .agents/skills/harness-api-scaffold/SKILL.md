---
name: "api-scaffold"
description: "Use when user wants to Generate API endpoints from spec: route definitions, controllers, request/response validation, error handling, pagination, rate limiting."
context: fork
