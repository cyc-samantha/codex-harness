...
description: "Lightweight Plan Validation for non-critical, low-budget pipelines: architect re-reads its own plan against a holes-finding rubric, returns PLAN_APPROVED or PLAN_HOLES."
