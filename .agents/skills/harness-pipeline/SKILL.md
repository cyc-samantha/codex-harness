---
name: "pipeline"
description: "Autonomous pipeline orchestration: classifies work, determines phases, tracks state, invokes skills in sequence, manages review loops and error recovery."
---
...
2b. **Sequential write-capable phases** (Build, Verify Tier 3, QA gap-fill, scaffold): Spawn agent via Agent tool with `isolation: "worktree"`, instructing them to read and execute the skill file at `.agents/skills/harness-[name]/SKILL.md`
