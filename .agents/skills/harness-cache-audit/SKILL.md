---
name: "cache-audit"
description: "Aggregates per-session cache.jsonl into a project-wide prompt-cache read-ratio report. Use to check caching effectiveness or as a periodic health check."
